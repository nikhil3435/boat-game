...
Bullet::Bullet(float x, float y,float z, color_t color) {
    ...
    static const GLfloat vertex_buffer_data[] = {
        ...
        0.05f, 0.05f,0.0f, // triangle 2 : begin
        -0.05f,-0.05f,0.0f,
    ...
    this->object = create3DObject(GL_TRIANGLES, 12*3, vertex_buffer_data, COLOR_ORANGE, GL_FILL);
}
...
void Bullet::draw(glm::mat4 VP) {
    ...
    //4 rotate          = rotate * glm::translate(glm::vec3(0, -0.6, 0));
